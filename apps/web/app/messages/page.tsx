...
export default function MessagesPage(){
 ...
 async function send(){if(!active||!content.trim())return; const r=await fetch(`${API}/messages/${active.id}`,{method:'POST',headers,body:JSON.stringify({content})}); if(r.ok){const d=await r.json();setHistory(x=>[...x,d]);setContent('');}}
